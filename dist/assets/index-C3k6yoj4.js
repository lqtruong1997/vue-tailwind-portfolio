function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["./WorkView-DZ3XmgJg.js","./WorkView-CBhX1dxH.css","./PlaygroundView-Dgl_ygxY.js","./PlaygroundView-9i7hJOFI.css"]
  }
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ai,depthTest:!1,depthWrite:!1})}function Zh(){return new Li({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Pc(),fragmentShader:`
		...
		`,blending:Ai,depthTest:!1,depthWrite:!1})}function Jh(){return new Li({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Pc(),fragmentShader:`
...
`].filter(Mr).join(`
`)),o=Kl(o),o=lf(o,t),o=cf(o,t),a=Kl(a),a=lf(a,t),a=cf(a,t),o=uf(o),a=uf(a),t.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
`)+`
`+p);const y=T+m+o,w=T+p+a,D=of(s,s.VERTEX_SHADER,y),R=of(s,s.FRAGMENT_SHADER,w);s.attachShader(x,D),s.attachShader(x,R),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function C(G){if(n.debug.checkShaderErrors){const V=s.getProgramInfoLog(x).trim(),L=s.getShaderInfoLog(D).trim(),Z=s.getShaderInfoLog(R).trim();let te=!0,Q=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(te=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,x,D,R);else{const le=af(s,D,"vertex"),X=af(s,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
